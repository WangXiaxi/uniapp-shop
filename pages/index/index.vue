<template>
	<view class="container">
		...
		<view class="carousel-section">
			...
			<swiper autoplay class="carousel" circular @change="swiperChange">
		...
		methods: {
			...
			loadDataDe() {
				...
				mineModel.getBannerList({
					...
					const carouselList = res.data.map(c => {
						c.src = `${url_image}/${c.img}`
						c.background = c.background ? c.background : '#ea1212'
						return c
					})
