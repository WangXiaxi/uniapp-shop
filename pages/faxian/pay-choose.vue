	...
	<view class="container">
		...
		<view class="info-box">
			...
			<view class="spec-list">
				<view class="item" :class="{ act: item.key === formData.param1 }" v-for="(item, index) in options1"
				 :key="index" @click="choose(item, 'param1')">
					{{item.label}}
				</view>
			</view>
			<view class="tip-title">
			...
			<view class="spec-list">
				<view class="item" :class="{ act: item.key === formData.param2 }" v-for="(item, index) in options2"
				 :key="index" @click="choose(item, 'param2')">
					{{item.label}}
				</view>
			</view>
		</view>
		<!-- 提示 -->
		<view class="tips">
			<view class="tit"><image src="../../static/icon/tips.png"></image>重要提示</view>
			<view class="info">
