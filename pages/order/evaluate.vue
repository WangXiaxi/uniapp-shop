<template>
	<view class="content">
		<view class="goods-box-single">
			<image class="goods-img" :src="detail.img" mode="aspectFill"></image>
			<view class="right">
				<text class="title">{{detail.goods_array.name}}</text>
			</view>
		</view>
		<view class="star-box">
			<view class="item">
		...
		<view class="remark">
			<textarea class="text-area" v-model="remark" placeholder="写一写您的想法和评价，说一说这里的优点和特点。您的评价对其他人很有用，晒图更好哦！" placeholder-class="placeholder"></textarea>
...
<script>
	...
	export default {
		...
		methods: {
			confirm() { // 评论提交操作
				const { imageList, remark, point, detail: {}} = this
				// if () {}
			},
			changeStar(data) {
